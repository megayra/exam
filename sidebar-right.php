...
<head>
<title>Kotlin</title>
<meta keywords="kotlin, LLVM" />
<meta description="Website for Kotlin language" />
<meta charset="utf-8">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      <h1>Kotlin</h1>
	  <p class="p1" >Kotlin e статично-типизиран програмен език, който върви на Java виртуална машина и може да бъде компилиран заедно с JavaScript source code или да използва компилатор с LLVM* структура. Името идва от о-в Котлин, финския залив, в близост до Кронщад.

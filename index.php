...
<html>
<head>
<title>Бъдещето е в нас</title>
<meta http-equiv="content-type" content="text/html; charset="utf-8">
<meta keywords="technology, c sharp" />
<meta description="This is site about information technology"/>
<meta property="og:title" content="Site about technology"/>  
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
<link href="styles/layout.css" rel="stylesheet" type="text/css" media="all">
</head>
<body id="top">
<nav class="wrapper row0">
      ...
      <div class="table-row"> 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <p class="just">Понятието „информационни технологии“ в съвременния си смисъл е използвано за пръв път през 1958 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <p class="just">В центъра на информационните технологии е информацията – тяхната основна задача е автоматизиране и систематизиране на работата 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-angellist"></i></a>
            ...
            <p class="just">Информационните технологии използват за обработка и съхранение на информация електронноизчислителни машини – компютри. 
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p class="nospace" id="none">&fgdlgdgdfl gldfl gldfl glfld</p>
    </div>
  ...
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="just">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="just">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono. 
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="just">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#. 
